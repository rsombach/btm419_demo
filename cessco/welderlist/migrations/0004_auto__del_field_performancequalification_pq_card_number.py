...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'PerformanceQualification.pq_card_number'
        db.delete_column(u'welderlist_performancequalification', 'pq_card_number')


    def backwards(self, orm):
        # Adding field 'PerformanceQualification.pq_card_number'
        db.add_column(u'welderlist_performancequalification', 'pq_card_number',
