...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Welder.absa_number'
        db.delete_column(u'welderlist_welder', 'absa_number')
        ...
        # Adding field 'PerformanceQualification.absa_number'
        db.add_column(u'welderlist_performancequalification', 'absa_number',
                      self.gf('django.db.models.fields.CharField')(default='XXXXXX', max_length=16),
                      keep_default=False)

        # Adding field 'PerformanceQualification.start_date'
        db.add_column(u'welderlist_performancequalification', 'start_date',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'PerformanceQualification.end_date'
        db.add_column(u'welderlist_performancequalification', 'end_date',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Welder.absa_number'
        db.add_column(u'welderlist_welder', 'absa_number',
                      self.gf('django.db.models.fields.CharField')(default='XXXXXX', max_length=16),
                      keep_default=False)
        ...
        # Deleting field 'PerformanceQualification.absa_number'
        db.delete_column(u'welderlist_performancequalification', 'absa_number')

        # Deleting field 'PerformanceQualification.start_date'
        db.delete_column(u'welderlist_performancequalification', 'start_date')

        # Deleting field 'PerformanceQualification.end_date'
        db.delete_column(u'welderlist_performancequalification', 'end_date')
