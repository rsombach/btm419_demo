...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Welder.welder_stamp'
        db.add_column(u'welderlist_welder', 'welder_stamp',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['core.WelderStampLov']),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Welder.welder_stamp'
        db.delete_column(u'welderlist_welder', 'welder_stamp_id')
